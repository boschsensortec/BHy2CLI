...
@echo ---------------------------------------------------------- 
@echo        Build MCU_APP31 binary for BHyCLI (I2C, SPI) 
@echo ----------------------------------------------------------

:: Build binary for BHyCLI for TARGET MCU_APP31 with I2C Interface
...
:: Build binary for BHyCLI for TARGET MCU_APP31 with SPI Interface
